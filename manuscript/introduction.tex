...
%
% how polyploidy breaks down SI
% how that generates associations (and variable associations of mating system and ploidy! husband2008, others cited by barrett_2013

% Breeding systems also affect diversification rate and so there could be an interaction
