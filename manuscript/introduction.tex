...
In these systems, self-incompatibility is thought to occur because haploid self-pollen grains, with one S-allele at the locus controlling the SI response, are unable to detoxify the S-RNase produced by the same S-allele in the style \kubo{2010}. 
