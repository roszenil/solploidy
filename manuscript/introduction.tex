...
% R- The graphical model coding is not about the figures but about how you code the nodes in the code. But I agree that it might be confusing especiallly for most botanists.
...
%B: I altered this line, but it is still a bit redundant given previous sentence.R-fixed
