...
Most significantly, we found that the effects of ploidy, inferred as significant when it is the only trait under consideration, are trumped by hidden states and or/ breeding system when added to models.  % E: is "trumped" too much like gloating? - R-Haha
%R- I added hidden states because that hasn't been discussed ever in polyploidy
...
Motivated by the widespread findings of paleopolyploid ancestry across angiosperms, we also examined support for diploidization in the history of the family, which appears to be weak. %B: "mixed" "not strong" what's the right word here?  E: not "weak", maybe "not strong" or "not nearly as strong as anything else"
