...
\subsection*{Disentangling trait interactions in the context of diversification} %RB: merged two titles; good?
...
%B: pre-conflict comment: "Genomic evidence" reads as if the "genomes" support this. But "genomic evidence" also does not support the statement (e.g., widespread synteny). Genomes are the data used in studies, not the evidence (it comes from different modes of genomic analysis).
