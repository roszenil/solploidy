...
\subsection*{Disentangling trait interactions in the context of diversification} %RB: merged two titles; good? % R-Good
...
Following polyploidization, it is possible for genome reorganization, downsizing, and loss to occur \citep{dodsworth_2015, zenil_2016, mandakova_2018}. %B: commas, etc.: importantly rm: "has been observed" this is _only_ true on very, very, short time scales
