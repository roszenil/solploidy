...
% R- not entering into the weeds of Ks plots
%f this is the case, then all of the genomes may have been subsequently diploidized, yielding the widespread and frequent chromosome numbers in this and closely related families, n=11--12, all presently considered to be diploid \citep{robertson_2011}. 
...
% R- This is redundant now we said it above
...
% R- removed the  inversion discussion I think the point was made above about the map base genome is sufficient. We don't need to describe more specifics
