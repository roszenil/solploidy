...
Below, we discuss these key findings and detail their sometimes confusing and complex implications.
...
% E: To elaborate: In the IC/CD/CP model, the CP state would be subdivided into two hidded values, corresponding to the influx from the two pathways.  Those two states, CP_X and CP_Y, could have different lambda and mu.
