...
% E: "Lumpable" is the math word for a particular relation among state codings, used in that Tarasov paper.  I don't think we want to get into defining it precisely.  Instead, we want Fig 1 to make it intuitively clear, to Spencer and everyone else.  Probably need to add to its caption.
