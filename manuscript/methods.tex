...
% As a second step, we fit a hidden state speciation and extinction model (HiSSE, \citet{beaulieu_2016}) to evaluate whether the differences in diversification rates were found due to a hidden trait associated to polyploidy.
...
\subsection{Models Breeding System and Diversification}
