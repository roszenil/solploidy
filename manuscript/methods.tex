...
In order to test our hypotheses about lineage diversification and trait macroevolution, we fitted 29 state-dependent speciation and extinction models (SSE) based on previous work from \citep[BiSSE, MuSSE, HiSSE;][]{maddison_2007, fitzjohn_2012, beaulieu_2016}.
