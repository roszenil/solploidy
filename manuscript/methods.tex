...
% E: also need some text about how SI was scored
...
We first defined a binary state speciation and extinction model (BiSSE, \citet{maddison_2007})  for polyploidy evolution where taxa was classified as diploid (D=0) and polyploid (P=1) \cref{table:datatable}.
...
% E: above and below, drop numerical state names ... even in the table
...
% E: lack of SI-P should maybe be explained in Intro?
...
A correction for sampling bias was done in all models by assuming that Solanaceae family has approximately 3,000 species ($s=595/3000$) as the Solanaceae Source project indicates \citep{source_2011}.
