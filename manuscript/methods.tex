...
This model was previously used in \citet{freyman_2018} to examine the effect of
breeding system on diversification in the plant family Onagraceae.
...
Previous modeling approaches \citep{mayrose_2011} have argued against inferring diploidization rates when using ploidy data that comes from classifications based on chromosome number multiplicity or chromosome number change models \citep{mayrose_2010, glick2014chromevol, freyman_2017}.
