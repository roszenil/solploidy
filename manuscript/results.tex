...
% E & B:  We just spent awhile poring over the great supp figures of rate estimates, which are essential to grasp the uncertainties.  But to facilitate quick comparisons across models, could we have a table of the median rate estimates for all models?  Possibly like the format I've laid out below?  Or maybe there's a better way.
