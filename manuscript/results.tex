...
When considered separately, ploidy and breeding system each showed significant associations with net diversification differences in Solanaceae.
...
In the one-step pathway, polyploidization directly disable SI.
