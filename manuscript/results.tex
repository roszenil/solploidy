...
Whether the determination of the diversification is dependent on the focal traits and not only on the hidden state was done via the comparisons of character independent models against the focal traits w/o hidden states models (results shown in  \cref{table:bayesfactors},\cref{table:M11M15},\cref{supptable:M6M10},\cref{supptable:M16M20},\cref{supptable:M21M25}).
...
For the models that only include diploid and polyploid states (M6-M10) the results are similar in terms of the effect of diversification (\cref{figure:alldip}).
