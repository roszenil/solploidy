...
%B: how about below; was: We found that when considered alone, ploidy and breeding system each showed significant associations with net diversification differences. 
...
%B: I am not sure I understand the "However, " sentence. TODO.
...
\caption{Posterior distribution for each of the parameters in the D/P+A/B, polyploidy model.  The axis is offset in one location so that the two overlapping distributions can be seen.} % XXX
