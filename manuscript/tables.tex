...
\end{tabular}
\caption{Bayes factors for ploidy-only models with diplodization. 
Results indicate that a character-independent model (M6) is strongly preferred over BiSSE (M1) model. 
M6 is moderately preferred over any of the HiSSE models with asymmetric hidden rates (M9, M10).}
\label{table:M6M10}
\end{table}
...
\end{tabular}
\caption{Bayes factors for breeding system-only models. 
Results indicate that the HiSSE models with asymmetric rates (M14, M15) are strongly preferred over other models.}
\label{table:M11M15}
\end{table}
...
\end{tabular}
\caption{Bayes factors of ploidy and breeding system with diploidization. 
Results indicate that the MuHiSSE model with asymmetric hidden rates (M24) is strongly preferred over M21-M23 and moderately preferred over the MuHiSSe with all rates asymetric (M25).}
\label{table:M21M25}
\end{table}
...
\end{tabular}
\caption{Test for symmetry of the hidden and trait rates via Bayes factors. 
For all models asymmetric hidden transition rates are preferred over models with equal hidden rates. 
Adding more complexity by assuming asymmetry in the trait rate within hidden states does not improve models.}
...
\end{tabular}
\caption{Test for addition of hidden states in models via Bayes factors. 
Models with hidden states are strongly preferred over simpler models}
...
\textbf{M24. IC/CD/CP+A/B+$\delta$ asym} & \textbf{-1386.20}                                                 &             &                 &                                                                      \\ \hline
\end{tabular}
\caption{Test for inclusion of a diploidization rate via Bayes factors. 
Models with diploidzation are moderately preferred over models that do not include a diploidization rate}
...
\end{tabular}
\caption{Test for adding a focal trait to a binary state model via Bayes factors. 
Three-state modes are moderately preferred over two-state models. 
The evidence is stronger towards the inclusion of breeding system in ploidy models (M26, M27) than the inclusion of ploidy in breeding system models (M29, M29)}
