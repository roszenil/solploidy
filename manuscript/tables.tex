...
\end{tabular}
\caption{Bayes factors of  ploidy only models with diplodization. Results indicate that a character independent model (M6) is strongly preferred over BiSSE (M1)  model. M6 is moderately preferred over any of the HiSSE model swith asymmetric hidden rates (M9, M10).}
\label{table:M6M10}
\end{table}
...
M11. I/C                   & -1309.07                                                          & 41.13 & 38.59 & 61.34 & 61.40 & \begin{tabular}[c]{@{}l@{}}Every model strongly \\ preferred over M111\end{tabular}            \\ \hline
