...
p = plot_ancestral_states("~/revbayes-master/projects/cmake/output/anc_states_summaryBiSSE_polynodip.tree", size=0.4, include_start_states=FALSE, summary_statistic="MAP",tip_label_size=0.5, tip_label_offset=0.4,tip_label_italics=TRUE,node_label_size=2,node_label_nudge_x=0.1,shoulder_label_size=2,alpha=.3,node_size_range=c(2, 6))
print(p)
